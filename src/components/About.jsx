        ...
        <div className=" text-black text-center container md:w-4/6 mx-auto">
            <div className="about text-xl">
                ...
                <div className="descripcion">
                    ...
                    <p>Mi principal objetivo es poner en práctica las tecnologías que he ido aprendiendo tanto en mi carrera como de forma autodidácta.</p>
                    <p>Mi principal objetivo es ganar experiencia en el desarrollo web frontend, para, posteriormente adquirir nuevos conocimientos en el área del backend.</p>
                    <p>Tengo una gran pasion por el desarrollo de software, siempre trato de mejorar cada dia, aprendiendo nuevas habilidades y poniendolas en práctica mediante proyectos personales.
                    </p>
                </div>
